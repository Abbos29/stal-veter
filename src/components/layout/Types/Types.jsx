            ...
            <div className={s.card}>
              ...
              <div className={s.box}>
                ...
                <p>
                  ...
                  претенденты на роль ключевых. А также базовые сценарии
                  поведения пользователей указаны как претенденты на роль
                  ключевых. А также базовые сценарии поведения пользователей.
                </p>

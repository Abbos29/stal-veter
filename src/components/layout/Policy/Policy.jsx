    ...
    <>
      ...
      <section className={s.privacy}>
        <Container>
          ...
          <p>
            Настоящий документ «Политика конфиденциальности» представляет собой
            правила использования сайта, мы данных интернет-пользователей,
            собираемых с использованием сайта «Стальной ветер».
          </p>
          ...
          <p>
            <strong>Пример!</strong> К указанному программному обеспечению
          ...
          <p>
            ...
            Интернет по адресу. Действующая редакция Политики от __________ 20__
            г.
          </p>
          ...
          <p>
            ООО "СТАЛЬНОЙ ВЕТЕР"
            <br />
            ИНН: 4802013668 | КПП: 482301001 | ОГРН: 1194827007275
            <br />
            ...
            <br />
            E-mail: info-sv48@yandex.ru | Телефон: +7 (4742) 370-577
            <br />
            Генеральный директор В. В. Жигулин, действующий на основании Устава
          </p>

          <p className={s.copyright}>
            © Стальной ветер {new Date().getFullYear()}
          </p>
        </Container>
      </section>
      <Footer />
